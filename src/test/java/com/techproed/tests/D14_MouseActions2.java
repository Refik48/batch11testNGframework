...
public class D14_MouseActions2 extends TestBase {
    ...
    // 4- Double Click Me! butonuna tiklayalim ve
    // cikan mesajin "Double  Clicked !!" oldugunu dogrulayalim
    // 5- Drag and drop kutularini kullanin ve islemi yaptiktan sonra
    // hedef  kutuda "Dropped!" yazildigini dogrulayin
